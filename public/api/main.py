...
FEDERATED_API_KEY = os.getenv("FEDERATED_API_KEY", "lightning-secret-key") # Default for demo, should be set in env
...
async def lifespan(app: FastAPI):
    ...
    shared.http_client = httpx.AsyncClient(timeout=10.0)
